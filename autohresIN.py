...
loginButton.click()
timeinButton = driver.find_element_by_xpath('//*[@id="inspire"]/div[2]/main/div/div[2]/div/div/div[2]/div/div/div[1]/button[1]')
timeinButton.click()
...
sortDate.click()
time.sleep(1)
timeIN = driver.find_element_by_xpath('//*[@id="inspire"]/div[2]/main/div/div[2]/div/div/div[2]/div/div/div[2]/div/div/div/table/tbody/tr[1]/td[2]').text

import pymsgbox
pymsgbox.alert('Timed-in @ ' + timeIN, 'HRES', 'OK')